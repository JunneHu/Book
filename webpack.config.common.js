...
export default {
  ...
  plugins: [
    ...
    new CopyPlugin([
      ...
      {
        context: __dirname,
        from: join(__dirname, directory.development.envName, directory.development.config, 'jquery.js'),
        to: join(__dirname, directory.production.envName, directory.production.resource, directory.production.javascript),
      }
    ]),
    new CopyPlugin([
      {
        context: __dirname,
        from: join(__dirname, directory.development.envName, directory.development.sprite, 'browser.png'),
        to: join(__dirname, directory.production.envName, directory.production.resource, directory.production.asset),
      }
    ]),
